...
function wpt_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_panel( 'mobile_menu_settings', array(
	  'priority' => 1000,
	  'theme_supports' => '',
	  'title' => __( 'Mobile Menu Settings', 'adagio-foundation-starter' ),
	  'description' => __( 'Controls the mobile menu', 'adagio-foundation-starter' ),
	) );

	// Create custom field for mobile navigation layout
	$wp_customize->add_section( 'mobile_menu_layout' , array(
		'title'	=> __('Mobile navigation layout','adagio-foundation-starter'),
	...
	$wp_customize->add_setting(
		...
		array(
			'default'	=> __( 'topbar', 'adagio-foundation-starter' ),
		)
	);
